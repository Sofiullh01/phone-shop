            ...
            <li className="block p-1 font-sans text-sm font-normal leading-normal text-inherit antialiased">
                  <NavLink
                    ...
                    className={({ isActive, isPending }) =>
                      isPending ? "pending" : isActive ? "bg-slate-600 text-white px-5 py-2 rounded-md hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" : ""
                    }
                  >
                    Home
                  </NavLink>
